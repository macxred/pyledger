...
EXPECTED_BALANCES_CSV = """
    ...
    2023-12-31, 1000:1999,                         , Assets, VAT Recoverable (Input VAT),    1300,      USD,     0.0, 0.0
              ,          ,                         , Assets,            Cash in Bank USD,    1000,      USD,     0.0, 0.0
              ,          ,                         , Assets,      Cash in other Bank USD,    1005,      USD,     0.0, 0.0
              ,          ,                         , Assets,            Cash in Bank EUR,    1010,      EUR,     0.0, 0.0
              ,          ,                         , Assets,      Cash in other Bank EUR,    1015,      EUR,     0.0, 0.0
              ,          ,                         , Assets,            Cash in Bank JPY,    1020,      JPY,     0.0, 0.0
              ,          ,                         , Assets,            Cash in Bank CHF,    1025,      CHF,     0.0, 0.0
    2024-01-01, 1000:1999,                         , Assets, VAT Recoverable (Input VAT),    1300,      USD,        0.0, 0.0
              ,          ,                         , Assets,            Cash in Bank USD,    1000,      USD,   800000.0, 800000.0
              ,          ,                         , Assets,      Cash in other Bank USD,    1005,      USD,        0.0, 0.0
              ,          ,                         , Assets,            Cash in Bank EUR,    1010,      EUR,      120.0, 132.82
              ,          ,                         , Assets,      Cash in other Bank EUR,    1015,      EUR,        0.0, 0.0
              ,          ,                         , Assets,            Cash in Bank JPY,    1020,      JPY, 42000000.0, 298200.0
              ,          ,                         , Assets,            Cash in Bank CHF,    1025,      CHF,        0.0, 0.0
    2024-01-01,      1000,                         , Assets,            Cash in Bank USD,    1000,      USD, 800000.0, 800000.0
    2024-Q4,    1000:1999,                         , Assets, VAT Recoverable (Input VAT),    1300,      USD,                0.0, 0.0
              ,          ,                         , Assets,            Cash in Bank USD,    1000,      USD,           300000.0, 300000.00
              ,          ,                         , Assets,      Cash in other Bank USD,    1005,      USD,                0.0, 0.0
              ,          ,                         , Assets,            Cash in Bank EUR,    1010,      EUR,        10076638.88, 11255605.63
              ,          ,                         , Assets,      Cash in other Bank EUR,    1015,      EUR,                0.0, 0.0
              ,          ,                         , Assets,            Cash in Bank JPY,    1020,      JPY,                0.0, 0.0
              ,          ,                         , Assets,            Cash in Bank CHF,    1025,      CHF,        14285714.29, 100000.00
    2024,       1000:1999,                         , Assets, VAT Recoverable (Input VAT),    1300,      USD,             360.85, 360.85
              ,          ,                         , Assets,            Cash in Bank USD,    1000,      USD,         1076311.79, 1076311.79
              ,          ,                         , Assets,      Cash in other Bank USD,    1005,      USD,             -100.0, -100.0
              ,          ,                         , Assets,            Cash in Bank EUR,    1010,      EUR,         10026687.1, 11199809.49
              ,          ,                         , Assets,      Cash in other Bank EUR,    1015,      EUR,              -20.0, -22.34
              ,          ,                         , Assets,            Cash in Bank JPY,    1020,      JPY,         54345678.0, 380419.75
              ,          ,                         , Assets,            Cash in Bank CHF,    1025,      CHF,        14285714.29, 100000.0
    2024-08,    1000:1999,                         , Assets, VAT Recoverable (Input VAT),    1300,      USD,     0.0, 0.0
              ,          ,                         , Assets,            Cash in Bank USD,    1000,      USD,  -700.0, -700.0
              ,          ,                         , Assets,      Cash in other Bank USD,    1005,      USD,     0.0, 0.0
              ,          ,                         , Assets,            Cash in Bank EUR,    1010,      EUR,     0.0, 0.0
              ,          ,                         , Assets,      Cash in other Bank EUR,    1015,      EUR,     0.0, 0.0
              ,          ,                         , Assets,            Cash in Bank JPY,    1020,      JPY,     0.0, 0.0
              ,          ,                         , Assets,            Cash in Bank CHF,    1025,      CHF,     0.0, 0.0
    2023-12-31, 1000:1999,                "General", Assets, VAT Recoverable (Input VAT),    1300,      USD,     0.0, 0.0
              ,          ,                         , Assets,            Cash in Bank USD,    1000,      USD,     0.0, 0.0
              ,          ,                         , Assets,      Cash in other Bank USD,    1005,      USD,     0.0, 0.0
              ,          ,                         , Assets,            Cash in Bank EUR,    1010,      EUR,     0.0, 0.0
              ,          ,                         , Assets,      Cash in other Bank EUR,    1015,      EUR,     0.0, 0.0
              ,          ,                         , Assets,            Cash in Bank JPY,    1020,      JPY,     0.0, 0.0
              ,          ,                         , Assets,            Cash in Bank CHF,    1025,      CHF,     0.0, 0.0
    2024-01-01, 1000:1999,                "General", Assets, VAT Recoverable (Input VAT),    1300,      USD,        0.0, 0.0
              ,          ,                         , Assets,            Cash in Bank USD,    1000,      USD,   800000.0, 800000.0
              ,          ,                         , Assets,      Cash in other Bank USD,    1005,      USD,        0.0, 0.0
              ,          ,                         , Assets,            Cash in Bank EUR,    1010,      EUR,      120.0, 132.82
              ,          ,                         , Assets,      Cash in other Bank EUR,    1015,      EUR,        0.0, 0.0
              ,          ,                         , Assets,            Cash in Bank JPY,    1020,      JPY, 42000000.0, 298200.0
              ,          ,                         , Assets,            Cash in Bank CHF,    1025,      CHF,        0.0, 0.0
    2024-01-24,      1000,  "General, Shop, Bakery", Assets, Cash in Bank USD,    1000,      USD, 801200.0, 801200.0
    2024-03-31, 1000:1999,  "General, Shop, Bakery", Assets, VAT Recoverable (Input VAT),    1300,      USD,        0.0, 0.0
              ,          ,                         , Assets,            Cash in Bank USD,    1000,      USD,   801200.0, 801200.0
              ,          ,                         , Assets,      Cash in other Bank USD,    1005,      USD,        0.0, 0.0
              ,          ,                         , Assets,            Cash in Bank EUR,    1010,      EUR,      120.0, 132.82
              ,          ,                         , Assets,      Cash in other Bank EUR,    1015,      EUR,        0.0, 0.0
              ,          ,                         , Assets,            Cash in Bank JPY,    1020,      JPY, 42000000.0, 298200.0
