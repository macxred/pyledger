...
RECONCILIATION_CSV = """
    period,         account, currency,          profit_center,       balance,  report_balance, tolerance, document,                           file
...
EXPECTED_BALANCES_CSV = """
    ...
    2024-12-31, 1000:2999,                "General",    -1608535.79,   "{USD: -2119202.16, EUR: 27078.22, JPY: 54345678.0, CHF: 14285714.3}"
...
EXPECTED_RECONCILIATION = [{
        "period": "2023-12-31", "file_pattern": None, "reconciliation":
            """
        ...
        "period": "2024-12-31", "file_pattern": None, "reconciliation":
        """
            period,    account, currency, profit_center,     balance,  report_balance,  tolerance,                            document, actual_balance, actual_report_balance
        ...
        "period": "2024", "file_pattern": None, "reconciliation":
        """
            period,    account, currency, profit_center,       balance,  report_balance,  tolerance,                            document, actual_balance,  actual_report_balance
              2024,  1000:9999,      EUR,       General,      27078.22,             0.0,       0.01,        2024/reconciliation/2024.pdf,       27078.22,                   0.00
              2024,  1000:9999,      USD,       General,    -498332.82,             0.0,       0.01,        2024/reconciliation/2024.pdf,     -510666.37,                   0.00
        ...
        "period": "2024-Q3", "file_pattern": None, "reconciliation":
        """
            period,    account, currency, profit_center,   balance,  report_balance,  tolerance, document, actual_balance,  actual_report_balance
           2024-08,  1000:2999,      CHF,        Bakery,       0.0,             0.0,       0.01,         ,           0.00,                   0.00
        2024-09-25,       1000,      USD,              , 776311.79,       776311.79,        1.0,         ,      776311.79,              776311.79"""
    }, {
        "period": "2024-09", "file_pattern": None, "reconciliation":
        """
            period, account, currency, profit_center,   balance,  report_balance,  tolerance, document, actual_balance,  actual_report_balance
        2024-09-25,    1000,      USD,              , 776311.79,       776311.79,        1.0,         ,      776311.79,              776311.79"""
    }, {
        "period": "2023", "file_pattern": r"^2023/.*\.pdf$", "reconciliation":
        """
        ...
        "period": "2024", "file_pattern": r"^2024/financial/.*\.pdf$", "reconciliation":
        """
            period,    account, currency, profit_center,     balance,  report_balance,  tolerance,                            document,                            file, actual_balance,  actual_report_balance
        ...
        "period": "2024", "file_pattern": r"/custom/.*\.pdf$", "reconciliation":
        """
         period,    account, currency, profit_center,  balance,  report_balance,  tolerance, document,                            file, actual_balance,  actual_report_balance
        2024-08,  1000:2999,      CHF,        Bakery,      0.0,             0.0,       0.01,         ,  2024/financial/custom/data.pdf,            0.0,                    0.0"""
    }, {
        "period": "2024", "file_pattern": r".*/all\.pdf$", "reconciliation":
        """
            period,    account, currency, profit_center,    balance,  report_balance,  tolerance,                            document,                    file, actual_balance,  actual_report_balance
              2024,  1000:9999,      EUR,       General,   27078.22,             0.0,       0.01,        2024/reconciliation/2024.pdf,  2024/financial/all.pdf,       27078.22,                   0.00
              2024,  1000:9999,      USD,       General, -498332.82,             0.0,       0.01,        2024/reconciliation/2024.pdf,  2024/financial/all.pdf,     -510666.37,                   0.00
