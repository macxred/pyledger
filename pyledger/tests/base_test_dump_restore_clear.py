...
class BaseTestDumpRestoreClear(BaseTest):
    ...
    def test_restore(self, engine):
        ...
        assert_frame_equal(self.COST_CENTERS, engine.cost_centers.list(), ignore_row_order=True)
    ...
    def test_dump_and_restore_zip(self, engine, tmp_path):
        ...
        engine.cost_centers.mirror(self.COST_CENTERS)
        ...
        cost_centers = engine.cost_centers.list()
        ...
        assert_frame_equal(
            cost_centers, engine.cost_centers.list(), ignore_row_order=True, ignore_index=True
        )
    ...
    def test_clear(self, engine):
        ...
        assert engine.cost_centers.list().empty, "Cost centers was not cleared"
