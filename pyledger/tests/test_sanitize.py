...
def test_sanitize_target_balance(engine, capture_logs):
    ...
    # flake8: noqa: E501
    TARGET_BALANCE_CSV = """
        id,        date, account, contra, currency,         description, document, balance, lookup_period, lookup_accounts, lookup_profit_centers
    ...
    """
        # 11,  2024-01-01,    1000,   2000,      USD, invalid profit cntr,         ,       1,       2024-Q4,            1000, invalid_pc
        # 12,  2024-01-01,    1000,   2000,      USD,   valid profit cntr,         ,       1,       2024-Q4,            1000,
        # 12,  2024-01-01,    1000,   2000,      USD,   valid profit cntr,         ,       1,       2024-Q4,            1000, Shop
    ...
    engine.restore(
        accounts=accounts_df, tax_codes=tax_df, price_history=prices,
        assets=assets
    )
