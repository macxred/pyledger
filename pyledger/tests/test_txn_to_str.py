...
LEDGER_CSV = """
    id,   date, account, counter, currency,  amount, report_amount, tax_code, description, document
...
EXPECTED = {
    '1': (
        "2024-05-24\n"
        "account,amount,report_amount,contra,currency,document,description,tax_code\n"
        "1023,100.0,,,CHF,file1.txt,single 1,In8%"
    ),
    '2': (
        "2024-05-24\n"
        "account,amount,report_amount,contra,currency,document,description,tax_code\n"
        "1022,-100.0,,,USD,dir/file.txt,coll 1,In5%\n"
        "1022,1.0,,,USD,dir/file.txt,coll 1,\n"
        "1022,99.0,,,USD,,coll 1,"
    ),
    '3': (
        "2024-04-24\n"
        "account,amount,report_amount,contra,currency,document,description,tax_code\n"
        "1021,200.0,,,EUR,doc2.pdf,coll 2B,\n"
        ",200.0,,,EUR,doc1.pdf,coll 2A,In5%"
    ),
    '4': (
        "2024-05-25\n"
        "account,amount,report_amount,contra,currency,document,description,tax_code\n"
        "1022,300.0,,,USD,doc3.pdf,single 2,In2%"
    )
}
