...
ACCOUNT_CSV = """
    ...
    /Assets, 9996,      CHF,         , Transitory Account CHF
    /Assets, 9999,      CHF,         , Input Tax
"""
...
LEDGER_CSV = """
    ...
    1,  2024-05-24, 9992,            9995,      CHF,     100.00,                     , Test_VAT_code, pytest single transaction 1,      /file1.txt
    2,  2024-05-24, 9991,                ,      USD,    -100.00,               -88.88, Test_VAT_code, pytest collective txn 1 - line 1, /subdir/file2.txt
    2,  2024-05-24, 9991,                ,      USD,       1.00,                 0.89, Test_VAT_code, pytest collective txn 1 - line 1, /subdir/file2.txt
    2,  2024-05-24, 9991,                ,      USD,      99.00,                87.99, Test_VAT_code, pytest collective txn 1 - line 1,
    3,  2024-04-24,     ,            9990,      EUR,     200.00,               175.55, Test_VAT_code, pytest collective txn 2 - line 1, /document-col-alt.pdf
    3,  2024-04-24, 9990,                ,      EUR,     200.00,               175.55, Test_VAT_code, pytest collective txn 2 - line 2, /document-col-alt.pdf
    4,  2024-05-24, 9991,            9994,      USD,     300.00,               450.45, Test_VAT_code, pytest single transaction 2,      /document-alt.pdf
    ...
    11, 2024-05-24, 9992,                ,      CHF,     100.00,                     , Test_VAT_code, Collective transaction with zero amount,
